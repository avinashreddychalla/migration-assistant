...
All code changes have been committed to branch `appmod/java-upgrade-20251126125159`, here are the details:
6 files changed, 27 insertions(+), 15 deletions(-)

- 207ce6b -- Upgrade project to use `Spring Boot 3.2.x`, `Java 21` using openrewrite.

- 95b8c95 -- Fix CVE-2020-17521 by upgrading groovy-all to 2.4.21
### Potential Issues
