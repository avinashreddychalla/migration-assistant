...
## Project Information
- **Project path**: C:\Users\avina\copilot-cli\baseline-projects\spring-boot-legacy
- **Working branch**: appmod/java-upgrade-20251218121425
...
1. Set up the development environment using tool #setup_upgrade_environment.
    ...
    - Create working branch `appmod/java-upgrade-20251218121425`.
